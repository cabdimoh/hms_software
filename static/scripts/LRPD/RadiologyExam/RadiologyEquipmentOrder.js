$(document).ready(function() {
    ...
    $("#SubmitOrder").on("click", function(e) {
        ...
        if (insertType == "Insert") {
            urls = "/prescription/manage-radiology-equipment-order/new_radiology_eq_order";
        } else {
            formData.append("TestID", $("#TestID").val());
            urls = "/prescription/manage-radiology-equipment-order/edit_test";
        }
        $.ajax({
            method: "POST",
            url: urls,
    ...
    $("#TestTable tbody").on("click", "#editButtonTest", function(e) {
        ...
        $.ajax({
            method: "POST",
            url: "/prescription/manage-radiology-equipment-order/get_test",
            headers: { "X-CSRFToken": csrftoken },
            processData: false,
            contentType: false,
            data: formData,
    ...
    $("#ItemCat").change(function() {
        ...
        let formData = new FormData();
        // Read user inputs
        formData.append("ItemCat", $("#ItemCat").val());


        $.ajax({
            method: "POST",
            url: "/prescription/manage-dropdown/get_option",
            headers: { "X-CSRFToken": csrftoken },
            processData: false,
            contentType: false,
            data: formData,
